...
public class AircraftLocomotionAuthoring : MonoBehaviour
{
    [SerializeField]
    float Speed = 3.5f;
    ...
    /// </summary>
    public AircraftLocomotion DefaultLocomotion => new()
    {
        Speed = Speed,
    ...
    public AircraftLocomotion EntityLocomotion
    {
        get => World.DefaultGameObjectInjectionWorld.EntityManager.GetComponentData<AircraftLocomotion>(m_Entity);
    ...
    void OnDestroy()
    {
        var world = World.DefaultGameObjectInjectionWorld;
        if (world != null)
            world.EntityManager.RemoveComponent<AircraftLocomotion>(m_Entity);
    }
}

internal class AircraftLocomotionBaker : Baker<AircraftLocomotionAuthoring>
{
    public override void Bake(AircraftLocomotionAuthoring authoring)
    {
