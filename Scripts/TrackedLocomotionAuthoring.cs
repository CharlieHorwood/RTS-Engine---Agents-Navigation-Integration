...
public class TrackedLocomotionAuthoring : MonoBehaviour
{
    [SerializeField]
    float Speed = 3.5f;
    ...
    /// </summary>
    public TrackedLocomotion DefaultLocomotion => new()
    {
        Speed = Speed,
    ...
    public TrackedLocomotion EntityLocomotion
    {
        get => World.DefaultGameObjectInjectionWorld.EntityManager.GetComponentData<TrackedLocomotion>(m_Entity);
...
internal class TrackedLocomotionBaker : Baker<TrackedLocomotionAuthoring>
{
    public override void Bake(TrackedLocomotionAuthoring authoring)
    {
