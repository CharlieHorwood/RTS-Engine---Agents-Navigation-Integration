...
{
    internal class InfantryNavController : MonoBehaviour, IMovementController
    {
        #region Engine Services & Entity Components
        ...
        public MovementControllerData Data
        {
            ...
            {
                data = value;
                var currentSteering = navAgent.DefaultLocomotion;
