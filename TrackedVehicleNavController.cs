...
{
    internal class TrackedVehicleNavController : MonoBehaviour, IMovementController
    {
        #region Attributes
        private TrackedLocomotionAuthoring TrackedLoco = null;
        ...
        public MovementControllerData Data
        {
            ...
            set
            {
                ...
                var currentSteering = TrackedLoco.EntityLocomotion;
